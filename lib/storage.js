...
export async function cargarPrograma(userId) {
  try {
    ...
    if (programa.bloques && !programa.programas) {
      console.log('🔄 Migrando estructura antigua a programas...')
      ...
      console.log('✅ Migración completada:', programaMigrado.programas.length, 'programas')
    ...
    console.log('Error cargando programa:', e)
...
export async function guardarMetrica(userId, metrica) {
  try {
    ...
    console.log('Error guardando métrica:', e)
  }
}
...
export async function eliminarMetrica(userId, index) {
  try {
    ...
    console.log('Error eliminando métrica:', e)
  }
}
...
export async function iniciarSesion(userId, bloqueId, diaKey) {
  try {
    ...
    return sesion
  } catch(e) { console.log('Error iniciando sesión:', e) }
}
...
export async function guardarSalud(userId, registro) {
  ...
  } catch(e) { console.log('Error guardando salud:', e) }
}
